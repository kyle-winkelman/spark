...
import org.apache.spark.api.java.function.{CoGroupFunction, CoGroupFunction2, CoGroupFunction3, CoGroupFunction4, CoGroupFunction5, CoGroupFunction6, CoGroupFunction7, FilterFunction, FlatMapFunction, FlatMapGroupsFunction, FlatMapGroupsWithStateFunction, ForeachFunction, ForeachPartitionFunction, MapFunction, MapGroupsFunction, MapGroupsWithStateFunction, MapPartitionsFunction, ReduceFunction}
...
private[sql] object ToScalaUDF extends Serializable {
  ...
  def apply[K, V1, V2, R](
      f: CoGroupFunction2[K, V1, V2, R]): (K, Iterator[V1], Iterator[V2]) => Iterator[R] =
    (k, v1, v2) => f.call(k, v1.asJava, v2.asJava).asScala

  def apply[K, V1, V2, V3, R](f: CoGroupFunction3[K, V1, V2, V3, R])
      : (K, Iterator[V1], Iterator[V2], Iterator[V3]) => Iterator[R] =
    (k, v1, v2, v3) => f.call(k, v1.asJava, v2.asJava, v3.asJava).asScala

  def apply[K, V1, V2, V3, V4, R](f: CoGroupFunction4[K, V1, V2, V3, V4, R])
      : (K, Iterator[V1], Iterator[V2], Iterator[V3], Iterator[V4]) => Iterator[R] =
    (k, v1, v2, v3, v4) => f.call(k, v1.asJava, v2.asJava, v3.asJava, v4.asJava).asScala
  ...
  def apply[K, V1, V2, V3, V4, V5, R](f: CoGroupFunction5[K, V1, V2, V3, V4, V5, R])
    ...
    (k, v1, v2, v3, v4, v5) =>
      f.call(k, v1.asJava, v2.asJava, v3.asJava, v4.asJava, v5.asJava).asScala
  ...
  def apply[K, V1, V2, V3, V4, V5, V6, R](f: CoGroupFunction6[K, V1, V2, V3, V4, V5, V6, R]): (
    ...
    (k, v1, v2, v3, v4, v5, v6) =>
      f.call(k, v1.asJava, v2.asJava, v3.asJava, v4.asJava, v5.asJava, v6.asJava).asScala
  ...
  def apply[K, V1, V2, V3, V4, V5, V6, V7, R](
    ...
    (k, v1, v2, v3, v4, v5, v6, v7) =>
      f.call(k, v1.asJava, v2.asJava, v3.asJava, v4.asJava, v5.asJava, v6.asJava, v7.asJava)
        .asScala
